...
const exerciseLibrary = [
  ...
  { name: 'Lunges', videoId: 'rjotIH8t0BY', instructions: 'Step forward with one leg. Lower hips until both knees bent at 90°. Front knee over ankle, back knee near ground. Push back to start.' },
  ...
  { name: 'Deadlift', videoId: 'pwGLw2xJCGw', instructions: 'Stand with feet hip-width apart. Hinge at hips, keeping back straight. Lower weight along shins. Drive through heels to stand up. Squeeze glutes at top.' },
...
function renderMovementLibrary() {
  ...
  container.innerHTML = `
    <div class="page-banner">
      <img src="https://ik.imagekit.io/0sf7uub8b/HydroFit/Grey%20Simple%20Fitness%20YouTube%20Thumbnail.png" alt="Movement Library" style="width:100%;border-radius:20px;box-shadow:var(--shadow)">
    </div>
